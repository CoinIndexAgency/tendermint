...
type AppConnMempool interface {
	...
	FilterTxsSync(types.RequestFilterTxs) (*types.ResponseFilterTxs, error)
...
func (app *appConnMempool) FilterTxsSync(req types.RequestFilterTxs) (*types.ResponseFilterTxs, error) {
	return app.appConn.FilterTxsSync(req)
}
